...
public class IntQueue1 {
    ...
    /* AF: 
     *   IntQueue such that the indexing of the linked list, entries, denotes
     *   the order that the Integers came in and the order that they will leave
     *   the queue.
     * 
     * RI:
     *    entries != null
     *    all items in list must be instance of Integer and not null
     */
