...
public class HW5TestDriver {
    ...
    private void addNode(String graphName, String nodeName) {
        ...
        Graph<String, String> thisGraph = graphs.get(graphName);
    ...
    private void addEdge(String graphName, String parentName, String childName,
        ...
        Node<String> src = new Node<String>(parentName);
        Node<String> dst = new Node<String>(childName);
        
        Edge<Node<String>, String> thisEdge = new Edge<Node<String>, String>(src, dst, edgeLabel);
    ...
    private void listChildren(String graphName, String parentName) {
        ...
        Collections.sort(tempSort, new Comparator<Edge<Node<String>, String>>() {
          ...
          public int compare(Edge<Node<String>, String> b1, Edge<Node<String>, String> b2) {
            int check = b1.getDstNode().toString().compareTo(b2.getDstNode().toString());
            if (check == 0) {
