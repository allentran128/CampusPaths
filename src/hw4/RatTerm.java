 ...
 * <p>
 *
 * A RatTerm, t, can be annotated by the pair (C . E), where C is the coefficient
...
public final class RatTerm {
  ...
  public RatNum getCoeff() {
    // RatNum is immutable so its okay to return this
    return this.coeff;
  }
  ...
  public RatTerm sub(RatTerm arg) {
    // negate the arg and add it to this
